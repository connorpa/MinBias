...
//                                            new const TH1D ("z", "z-position;x/mm;#entries", 100,  -20, 20) };
    ...
    // reconstructed tracks
        ...
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name]->SetTitle(TString::Format("%s of the reconstructed tracks with HFAnd selection", proto_tracks2[ikin]->GetTitle()));
        ...
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the reconstructed tracks with HFXor selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the reconstructed tracks with HFOr selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the reconstructed tracks with NoHF selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
...
//    }
    ...
    {   // create histograms for gen level with the exact same structure
        ...
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the generated tracks with HFAnd selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the generated tracks with HFXor selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the generated tracks with HFOr selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
        for (unsigned int ikin = 0 ; ikin < NKIN ; ikin++)
        {
            ...
            hist1D[name] = (TH1D *) proto_tracks2[ikin]->Clone(name);
            hist1D[name]->SetTitle(TString::Format("%s of the generated tracks with NoHF selection", proto_tracks2[ikin]->GetTitle()));
            hist1D[name]->SetXTitle(proto_tracks2[ikin]->GetXaxis()->GetTitle());
            hist1D[name]->SetYTitle(proto_tracks2[ikin]->GetYaxis()->GetTitle());
        }
//        for (unsigned int ieta = 0 ; ieta < NETABIN ; ieta++)
...
//Container histograms to chose the histogram to fill after the eventselection
  ...
  //      }
        ...
        for (unsigned int ikin = 1 ; ikin < 2 ; ikin++) //Just for pt destribution.
        {
            TString name = TString::Format("GT_HFOr_%s", proto_tracks2[ikin]->GetName());
