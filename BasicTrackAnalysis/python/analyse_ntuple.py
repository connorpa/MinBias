...
#        'file:/afs/desy.de/user/c/connorpa/CMSSW/CMSSW_7_4_0/src/MinBias/BasicTrackAnalysis/data/file_track_test.root'
#    )
#)
...
process.minbiasdata = cms.EDAnalyzer('TrackAnalysis'
