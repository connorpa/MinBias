...
process.rechitcorrector = cms.EDProducer("RecHitCorrector",
       rechitLabel = cms.InputTag("castorreco","","RERECO"), # choose the original RecHit collection
...
# Final Tree
process.TFileService = cms.Service("TFileService",fileName = cms.string("CastorTree_data_MinBias_Commissioning10-07JunReReco_900GeV_RECOwithCorrector.root"))
...
process.castortree = cms.EDAnalyzer('CastorTree',
   ...
   CastorDigiColl = cms.InputTag('castorDigis', '','RERECO'),
   ...
   CaloTowerColl = cms.InputTag('towerMaker','','RERECO'),
   ...
   requested_hlt_bits = cms.vstring('HLT_BackwardBSC','HLT_ForwardBSC','HLT_L1Tech_BSC_halo_forPhysicsBackground','HLT_L1_BscMinBiasOR_BeamGas',
	'HLT_L1_BscMinBiasOR_BptxPlusORMinus','HLT_L1_BscMinBiasOR_BptxPlusORMinus_NoBPTX','HLT_MinBiasBSC','HLT_MinBiasBSC_NoBPTX','HLT_MinBiasBSC_OR'),
